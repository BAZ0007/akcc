    ...
    <footer className="border-t border-slate-200/80 bg-navy-950 text-white">
      <Container className="grid gap-10 py-14 md:grid-cols-[1.4fr,1fr,1fr]">
        <div className="space-y-4">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-gold-300">AKCC</p>
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-300">Navigate</h3>
