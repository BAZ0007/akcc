    ...
    <section className="bg-hero-gradient py-24 text-white">
      <Container className="grid items-center gap-10 lg:grid-cols-[1fr,0.9fr]">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl">Sign in to manage the church website.</h1>
          <p className="max-w-2xl text-lg leading-8 text-slate-200">Use your admin email and password to access the AKCC CMS. You can also go directly to `/admin`.</p>
        </div>
